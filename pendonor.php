...
<body>
    ...
    <section id="content">
        ...
        <div class="container-fluid">
            <h2 class="text-center mt-3"><b>DATA PENDONOR</b></h2>
            <a target="_blank" href="cetak_pendonor.php" class="btn btn-outline-success float-end" style="margin-left: 2px;"><i class="bi bi-printer-fill m-2" style="font-size: 16px;"></i>Print</a>
            ...
            <table class="table table-condensed table-striped table-hover text-center w-100%" style="font-size: 12px; max-width: 100%;">
                ...
                <?php
                    $no = 1;
                    $tampil = mysqli_query($koneksi, "SELECT * FROM pendonor ORDER BY id_pendonor DESC");
                ...
                <div class="modal fade" id="FormEdit<?= $no ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form method="POST" action="aksi_crudpendonor.php">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="tnama" value="<?= $data['nama_pendonor'] ?>" placeholder="Masukkan Nama Pendonor">
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" name="tkategori" id="">
                            ...
                            <form method="POST" action="aksi_crudpendonor.php">
                                ...
                                <div class="modal-body">
                                    <h5 class="text-center">Apakah Anda Yakin Akan Menghapus Data Ini ?
                                        <br>
                                        <span class="text-danger"><?= $data['nama_pendonor'] ?> - Golongan Darah <?= $data['golongan_darah'] ?> </span>
                                    </h5>
                                </div>
                                <div class="modal-footer">
                    ...
                    <div class="modal-content">
                        ...
                        <form method="POST" action="aksi_crudpendonor.php">
                            <div class="modal-body">
                                ...
                                <div class="mb-3">
                                    <label class="form-label">Nama Pendonor</label>
                                    <input type="text" class="form-control" name="tnama" placeholder="Masukkan Nama Pendonor">
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Golongan Darah</label>
                                    <select class="form-select" name="tgol" id="">
